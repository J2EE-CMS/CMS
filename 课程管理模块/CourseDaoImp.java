...
public class CourseDaoImp implements ICourseDao{
	...
	public List<Course> queryCourse(Course cos, Date begin_time, Date end_time) {
	    ...
	    if(cos.getInstitute_course()!=null && !cos.getInstitute_course().equals("")){
	        crit.add(Restrictions.eq("institute_course",cos.getInstitute_course() ));
	    }	    
	    if(cos.getC_course_name()!=null && !cos.getC_course_name().equals("")){
		    crit.add(Restrictions.eq("c_course_name",cos.getC_course_name() ));
		}	  
	    if(cos.getE_course_name()!=null && !cos.getE_course_name().equals("")){
		    crit.add(Restrictions.eq("e_course_name",cos.getE_course_name() ));
		}	
	    if(cos.getBrief_course_name()!=null && !cos.getBrief_course_name().equals("")){
